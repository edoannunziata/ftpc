...
This module provides an async-compatible version of the TUI that uses
the AsyncRunner to execute async client operations without blocking
the UI thread.
"""
...
class AsyncTui:
    ...
    def __init__(self, client: AsyncClient, *, cwd: PurePath) -> None:
        ...
        self.upload_client: Optional[AsyncLocalClient] = None
                    ...
                    while True:
                        ...
                        match stdscr.getkey():
                            ...
                            case "/":
                                self.search_file()
                            case "u":
                                self.upload_client = AsyncLocalClient()
                                if self.mode == TuiMode.NORMAL:
